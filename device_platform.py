...
all_platforms = [
  ...
  DevicePlatform(cpid=0x8000, cprv=0x14, scep=0x01, arch='arm64', srtg='iBoot-2234.0.0.3.33',
    rom_base=0x100000000, rom_size=0x80000, rom_sha1='0a8116c3e54da9de9c144c745114b689e4940b41',
    sram_base=0x180000000, sram_size=0x400000,
    dram_base=0x800000000,
    nonce_length=20, sep_nonce_length=20,
    demotion_reg=0x20E02A000,
